...
export default function TechStackPage() {
  ...
  const handleDelete = async (id: number) => {
    const result = await Swal.fire({
      ...
      text: "Une donnée supprimée ne peut pas être récupérée.",
      icon: "warning",
    ...
    if (!error) {
      ...
      Swal.fire({
        title: "Échec",
        text: "Impossible de supprimer cette technologie.",
        icon: "error",
        background: "#111",
        color: "#fff",
      });
          ...
          <div className="w-full max-w-md rounded-3xl bg-[#111] border border-white/10 p-5 sm:p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg sm:text-xl font-semibold">
                {editId ? "Modifier la technologie" : "Ajouter une technologie"}
              </h2>
